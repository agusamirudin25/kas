    ...
    <div class="row ">
        <div class="col-lg">
            <div class="card">
                <div class="card-body">
                    <br>
                    <form autocomplete="off" method="post" action="<?= BASEURL . '/Pengeluaran/ubah' ?>" id="formSubmit" enctype="multipart/form-data">
                        <input type="hidden" value="<?= $dataAnggaran['id_anggaran'] ?>" name="id">
                        <input type="hidden" value="<?= $dataAnggaran['file_bukti'] ?>" name="file_bukti_lama">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group" id="wraper_nominal">
                                    ...
                                    <input type="text" id="nominal" value="<?= $dataAnggaran['nominal'] ?>" name="nominal" class="form-control nominalData" placeholder="nominal">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <?php if($dataAnggaran['file_bukti'] != null) : ?>
                                    <!-- show image -->
                                    <h6>File Sebelumnya</h6>
                                    <img src="<?= BASEURL . '/bukti/' . $dataAnggaran['file_bukti'] ?>" alt="<?= $dataAnggaran['file_bukti'] ?>" class="img-thumbnail" style="width: 200px;">
                                <?php endif ?>
                            </div>
                        </div>
                        <div class="form-group row">
